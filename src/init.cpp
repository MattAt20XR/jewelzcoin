...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/jewelzcoin-project/jewelzcoin>";
    const std::string URL_WEBSITE = "<https://jewelzcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("JewelzCoin version %s\n", FormatFullVersion());
}
