...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jewelzcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jewelzcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jewelzcoin transaction") + "\n" +
              "  jewelzcoin-tx [options] -create [commands]   " + _("Create hex-encoded jewelzcoin transaction") + "\n" +
              "\n";
